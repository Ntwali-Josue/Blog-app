...
describe 'Users Index Page', type: :feature do
  context 'when successfull' do
    ...
    it 'I can see the username of users in users index page.' do
      expect(page).to have_content(@user1.name)
      expect(page).to have_content(@user2.name)
      expect(page).to have_content(@user3.name)
    end

    it 'I can see the photo of users in users index page.' do
    ...
    it 'I can see number of posts for a user' do
      expect(page).to have_content(@user1.posts.count)
    end

    it 'directs to show page if user is clicked' do
